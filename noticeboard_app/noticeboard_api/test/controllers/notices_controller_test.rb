...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { author: @notice.author, phonew: @notice.phonew, title: @notice.title } }, as: :json
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { author: @notice.author, phonew: @notice.phonew, title: @notice.title } }, as: :json
    assert_response 200
  end
